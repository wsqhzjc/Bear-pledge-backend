...
//
// Solidity: function getInitCodeHash() view returns(bytes32)
func (_UniswapV2Router02 *UniswapV2Router02Caller) GetInitCodeHash(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _UniswapV2Router02.contract.Call(opts, &out, "getInitCodeHash")
...
//
// Solidity: function getInitCodeHash() view returns(bytes32)
func (_UniswapV2Router02 *UniswapV2Router02Session) GetInitCodeHash() ([32]byte, error) {
	return _UniswapV2Router02.Contract.GetInitCodeHash(&_UniswapV2Router02.CallOpts)
}

// GetInitCodeHash is a free data retrieval call binding the contract method 0x5431927d.
//
// Solidity: function getInitCodeHash() view returns(bytes32)
func (_UniswapV2Router02 *UniswapV2Router02CallerSession) GetInitCodeHash() ([32]byte, error) {
	return _UniswapV2Router02.Contract.GetInitCodeHash(&_UniswapV2Router02.CallOpts)
}
